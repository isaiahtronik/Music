...
module.exports.run = async (bot, message, args) => {
    ...
    if (!message.member.hasPermission('434928657157324801')) return utils.timed_msg(utils.no_perm(`${message.author}, you do have the permissions to run this command!`), 5000)
